...
const variantStyles = {
  solid: {
    ...
    yellow:
      "bg-yellow-300 text-black hover:bg-yellow-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-300 active:bg-yellow-500 active:text-white/80 disabled:opacity-30 disabled:hover:bg-yellow-600",
    white:
  ...
  outline: {
    ...
    yellow:
      "border-yellow-300 text-yellow-500 hover:border-yellow-400 hover:bg-yellow-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600 active:text-yellow-600/70 disabled:opacity-40 disabled:hover:border-yellow-300 disabled:hover:bg-transparent",
  },
};
